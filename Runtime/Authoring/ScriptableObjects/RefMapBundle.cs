...
namespace AlephVault.Unity.WindRose.RefMapChars
{
    namespace Authoring
    {
        namespace ScriptableObjects
        {
            ...
            /// </summary>
            [CreateAssetMenu(fileName = "NewRefMapBundle", menuName = "Aleph Vault/WindRose/RefMap Chars/RefMap Bundle", order = 101)]
            public class RefMapBundle : ScriptableObject
            {
...
#if UNITY_EDITOR
                [MenuItem("Assets/Create/Aleph Vault/WindRose/RefMap Chars/Full RefMap Bundle", true, 108)]
                ...
                [MenuItem("Assets/Create/Aleph Vault/WindRose/RefMap Chars/Full RefMap Bundle", false, 108)]
