...
namespace AlephVault.Unity.WindRose.RefMapChars
{
    namespace Authoring
    {
        namespace ScriptableObjects
        {
            ...
            /// </summary>
            [CreateAssetMenu(fileName = "NewRefMapItem", menuName = "Aleph Vault/WindRose/RefMap Chars/Standard Add-On (10 colors variations)", order = 105)]
            public class RefMapAddOn : ScriptableObject
            {
                ...
                [MenuItem("Assets/Create/Aleph Vault/WindRose/RefMap Chars/Standard Add-Ons (Bulk; 10 colors variations)", true, 108)]
                ...
                [MenuItem("Assets/Create/Aleph Vault/WindRose/RefMap Chars/Standard Add-Ons (Bulk; 10 colors variations)", false, 105)]
